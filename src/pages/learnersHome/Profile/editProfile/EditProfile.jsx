...
function EditProfile() {
  ...
  const { user, userId, username, useremail, userPhoto, userAddress, userPhoneNumber, userBio, userGender, userDob, userRole, userNation } = useSelector((state) => state.auth);
  useEffect(() => {
  ...
  }, [username, useremail, userPhoto, userAddress, userPhoneNumber, userBio, userGender, userDob, userRole, userNation]);
