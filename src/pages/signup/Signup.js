    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftDiv}>
        ...
        <h1 className={styles.headertext}>
          Join Skill Hub to <br /> activate your learning
        </h1>
      ...
      <div className={styles.rightDiv}>
        ...
        <form className={styles.form} onSubmit={handleSignup}>
          <div className={styles.inputGroup}>
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} className={styles.input} placeholder="Your name here" />
          </div>
          <div className={styles.inputGroup}>
            <label className={styles.label}>Email</label>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className={styles.input} placeholder="contact000@gmail.com" />
          </div>
          <div className={styles.inputGroup}>
